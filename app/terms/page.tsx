...
export const metadata = {
  title: "Terms of Service — BCL Meetings",
  description: "Terms of Service for BCL Meetings scheduling application by BookSmart Consultancy Limited.",
};
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-8 text-sm leading-7 text-slate-600 dark:text-slate-300">
          ...
          <section>
            ...
            <p>
              By accessing or using BCL Meetings ("the app") at{" "}
              <span className="text-blue-600 dark:text-blue-400">meetings.booksmartportals.com</span>, you
          ...
          <section>
            ...
            <p>
              BCL Meetings is a meeting scheduling tool operated by BookSmart Consultancy Limited.
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                When connecting your Google account, you authorise BCL Meetings to access your
          ...
          <section>
            ...
            <p>
              ...
              you grant BCL Meetings permission to create, update, and delete calendar events on
          ...
          <section>
            ...
            <p>
              Meeting data you enter into BCL Meetings belongs to BookSmart Consultancy Limited
          ...
          <section>
            ...
            <p>
              We aim to keep BCL Meetings available at all times but do not guarantee uninterrupted
          ...
          <section>
            ...
            <p>
              BCL Meetings is provided "as is". BookSmart Consultancy Limited is not liable for
