...
function toEventPayload(body: Record<string, any>, callerUser?: { id: string; email: string } | null) {
  ...
  return {
    ...
    event_slot_start_time: body.event_slot_start_time || startTime,
    event_slot_end_time: body.event_slot_end_time || endTime,
    venue_distance: toInteger(body.venue_distance, 10),
    event_format: body.event_format || 'physical',
    virtual_meeting_mode: body.virtual_meeting_mode ?? null,
